    ...
    */
    ...
    'connections' => [
        ...
        'sphinx' => [
            ...
            'database' => env('SPHINX_DATABASE', ''), // Not required for Sphinx
            'username' => env('SPHINX_USERNAME', ''), // Not required for Sphinx
            'password' => env('SPHINX_PASSWORD', '') // Not required for Sphinx
        ],
